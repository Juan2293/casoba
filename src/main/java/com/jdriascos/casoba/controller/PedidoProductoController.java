...
public class PedidoProductoController {
	...
	public ResponseEntity<List<PedidoProducto>> getPedidoProductoByPedidoId(@PathVariable Long pedidoId) {
		System.out.println("entro!");
		List<PedidoProducto> pedidoProducto = pedidoProductoService.getPedidoProductoByPedidoId(pedidoId);
		return new ResponseEntity<List<PedidoProducto>>(pedidoProducto, HttpStatus.OK);
	}
